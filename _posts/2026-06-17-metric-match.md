...
```
╔══════════════════════════════════════════════════════════════╗
║                   Metric Match Algorithm                     ║
╠══════════════════════════════════════════════════════════════╣
║                                                              ║
║  Input:  母體 X (N 筆樣本), LLM judge M,                     ║
║          輔助 judges M'₁ ... M'ₖ, 標註預算 b                 ║
║          候選子集數 C = 20, reliability metric T             ║
║                                                              ║
║  ┌─────────────────────────────────────────────────────┐    ║
║  │ Step 1: 計算母體 inter-model metric（免費）          │    ║
║  │                                                       │    ║
║  │  ρ_IM_pop = avg( T( M(x), M'ⱼ(x) ) )                │    ║
║  │             for all x ∈ X, j ∈ [1..k]                │    ║
║  │                                                       │    ║
║  │  ▸ 不需要任何人類標註，LLM 跑一遍就有                │    ║
║  └───────────────────┬─────────────────────────────────┘    ║
...
║  │                                                       │    ║
║  │  for i = 1 to C:                                     │    ║
║  │      Sᵢ  ← random_subset(X, b)    // 隨機抽 b 筆     │    ║
║  │      ρᵢ ← compute_inter_model(Sᵢ) // 算子集 IM metric│    ║
║  │                                                       │    ║
║  │  S* = argmin |ρᵢ - ρ_IM_pop|       // 挑最接近母體的 │    ║
║  │        i∈[1..C]                                      │    ║
║  └───────────────────┬─────────────────────────────────┘    ║
║                      │                                       ║
║                      ▼                                       ║
...
║  │ Step 3: 人類標註（唯一花錢的步驟）                   │    ║
║  │                                                       │    ║
║  │  只對 S* 中的 b 筆樣本進行人類標註 H(x)             │    ║
║  │  ▸ 醫療場景: $14/筆 × 46 筆 ≈ $644                  │    ║
║  └───────────────────┬─────────────────────────────────┘    ║
║                      │                                       ║
║                      ▼                                       ║
║  ┌─────────────────────────────────────────────────────┐    ║
║  │ Step 4: 估計母體 reliability                        │    ║
║  │                                                       │    ║
║  │  ρ̂ = T( { (M(x), H(x)) for x ∈ S* } )              │    ║
║  │                                                       │    ║
║  │  Output: ρ̂ 即為母體 human-model reliability 的估計  │    ║
║  └─────────────────────────────────────────────────────┘    ║
║                                                              ║
╚══════════════════════════════════════════════════════════════╝
```
