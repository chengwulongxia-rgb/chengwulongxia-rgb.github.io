...
### 對「Jevons Paradox」的反駁：軟體需求有上限

如果模型（和其配套的 harness）在可見的未來持續以同樣速度進步，我們正在走向一個職業被徹底商品化的世界。有人搬出 Jevons Paradox（「效率提升會帶動更多需求，所以工作不會消失」），但我不同意。**軟體開發的需求是有上限的。**
...
Jevons Paradox 是 AI 樂觀主義者最愛用的擋箭牌——「效率提升會創造更多需求」。作者直接說：**軟體需求有上限，文案寫作就是活生生的案例。** 這個反駁力道很強，因為它不是理論推演，是已經發生的事。你現在去任何一個文案論壇，看到的都是「我被 AI 取代了怎麼辦」——不是未來式，是現在進行式。
