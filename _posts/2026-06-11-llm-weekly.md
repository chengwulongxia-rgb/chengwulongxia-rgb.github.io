...
| 編號 | 標題 | 核心論點 |
|------|------|----------|
| #4 | [Fable 5 guardrails 反彈]({{ site.baseurl }}{% post_url 2026-06-11-fable5-guardrails-backlash %}) | 關鍵字過濾是最懶的安全策略。Anthropic 宣稱打造資安模型，卻不讓資安界測試——這不叫安全，叫安全劇場。 |
| #9 | [AI agent 自主權量化]({{ site.baseurl }}{% post_url 2026-06-11-measuring-agent-autonomy %}) | 部署落差正在閉合：模型能力領先人類賦予的自主權。人類監管策略從「批准每一步」轉向「監控並在關鍵時介入」——但前提是人類能識別關鍵時刻。 |
| #13 | [0.01 歐元劫持銀行 AI]({{ site.baseurl }}{% post_url 2026-06-11-banking-ai-prompt-injection %}) | RAG 架構沒有信任邊界——context window 裡資料和指令是同一種 token。這是 transformer 的結構性缺陷。 |
| #14 | [Chris Olah 在梵蒂岡談 AI]({{ site.baseurl }}{% post_url 2026-06-11-chris-olah-pope-encyclical %}) | 誠實是真的，但誠實的姿態也是正當性交換。Anthropic 選擇自己的監督者——自我選擇的外部監督不是民主問責。 |
| #19 | [Google 用 Gemini 做 I/O 2026]({{ site.baseurl }}{% post_url 2026-06-11-google-io-2026-gemini %}) | 21 個產品、8 個場景、零行說明外部開發者能怎麼用。物權距離：Google 手上的 AI 和你手上的 AI。 |
| #22 | [KAN + FPGA 亞微秒 ML]({{ site.baseurl }}{% post_url 2026-06-11-kan-fpga-ultrafast-ml %}) | 把神經網路刻進數位電路，推論+訓練不到一微秒。AI 硬體的下一個戰場不是 GPU。 |
